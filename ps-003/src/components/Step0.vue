<template>
  <a-layout-content class="bg-white h-4/5 p-6 flex">
        ...
        <div class="text-xl text-left align-middle mt-32 ml-4 text byellow">
          ...
          有人根据经验猜测，鱼缸中的水位、温度、水草数量以及鱼的数量等都有可能会对水的溶氧量造成影响。<br/>
           <div>
          <img src="https://cdn.bnutest.com/task-resources/mianyang/微信图片_20210716092904.jpg" width=400px height=300px>
        </div>
        </div>
      </a-layout-content>
</template>
